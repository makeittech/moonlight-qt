...
#define SER_AUTOCONNECT "autoconnect"
...
void StreamingPreferences::reload()
{
    ...
    autoConnectToLastHost = settings.value(SER_AUTOCONNECT, false).toBool();
...
void StreamingPreferences::save()
{
    ...
    settings.setValue(SER_AUTOCONNECT, autoConnectToLastHost);
}
