...
public:
    ...
    Q_PROPERTY(bool autoConnectToLastHost MEMBER autoConnectToLastHost NOTIFY autoConnectToLastHostChanged);
...
signals:
    ...
    void autoConnectToLastHostChanged();
